...
class Instruction(object):
    ...
    def encode(self) -> int:
        ...
        val = 0
        val = op_field.insert(self.op.value, val)
        val = cond_field.insert(self.cond.value, val)
        val = reg_target_field.insert(self.reg_target, val)
        val = reg_src1_field.insert(self.reg_src1, val)
        val = reg_src2_field.insert(self.reg_src2, val)
        val = offset_field.insert(self.offset, val)
        return val
